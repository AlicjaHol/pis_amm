...
plot(density(mod3$residuals), 
     main = "Wykres gęstości rozkładu reszt", ylab = "Gęstość")
...
plot(mcd, type = "l", main =  "Prognoza z całości danych na najbliższe 30 notowań", xlim = c(0,515), 
...
prognoza <- as.data.frame(prognoza)[,1]
plot(mcd, type = "l", main =  "Prognoza z ostatnich 20 notowań na najbliższe 30", xlim = c(0,515), 
     xlab = "Indeks notowań", ylab = "USD", lwd = 2)
t1 <- 503:(503+length(prognoza)-1)
lines(t1, prognoza, col = 3, lwd = 2)
```
...
Próbujemy przewidywać z modelu wielomianowego 3 stopnia.
